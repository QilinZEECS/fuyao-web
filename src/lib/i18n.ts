...
// Mentor list — names and titles are already English, identical across languages.
...
const zh: ContentShape = {
  ...
  HIGHLIGHTS: [
    { icon: "GraduationCap", title: "新锐赛道", description: "特设 New Grad / Career 初期赛道，为职场新人提供高起点的职业规划" },
  ...
  TIMELINE: [
    ...
    { date: "2026 年 4 月 - 9 月", title: "项目活动", description: "每月 1 次集体活动（Panel Discussion、讲座、BBQ 等），每月 1 次小组讨论，导师学员 1:1 深度交流，后期多组合并讨论" },
  ...
  PAST_TIMELINE: [
    ...
    { date: "2025 年 5 月", title: "Panel Discussion", description: "行业大咖闭门对话，聚焦 AI、Biotech 等前沿趋势", image: PAST_TL_IMG[2] },
    { date: "2025 年 6 月", title: "夏季 BBQ · 大组合并", description: "户外社交与跨组交流，打破小组边界", image: PAST_TL_IMG[3] },
  ...
  ACTIVITY_PHOTOS: [
    ...
    { src: PHOTO_SRC[2], alt: "导师演讲 — 从 Cornell 到 Nvidia 的职业旅程" },
  ...
  FOOTER: {
    ...
    copyright: `© ${year} 扶摇计划 All Rights Reserved.`,
    quickLinks: "快速链接",
    contactWay: "联系方式",
    language: "语言",
  },
...
const tw: ContentShape = {
  ...
  HIGHLIGHTS: [
    { icon: "GraduationCap", title: "新銳賽道", description: "特設 New Grad / Career 初期賽道，為職場新人提供高起點的職業規劃" },
  ...
  TIMELINE: [
    ...
    { date: "2026 年 4 月 - 9 月", title: "項目活動", description: "每月 1 次集體活動（Panel Discussion、講座、BBQ 等），每月 1 次小組討論，導師學員 1:1 深度交流，後期多組合併討論" },
  ...
  PAST_TIMELINE: [
    ...
    { date: "2025 年 5 月", title: "Panel Discussion", description: "行業大咖閉門對話，聚焦 AI、Biotech 等前沿趨勢", image: PAST_TL_IMG[2] },
    { date: "2025 年 6 月", title: "夏季 BBQ · 大組合併", description: "戶外社交與跨組交流，打破小組邊界", image: PAST_TL_IMG[3] },
  ...
  ACTIVITY_PHOTOS: [
    ...
    { src: PHOTO_SRC[2], alt: "導師演講 — 從 Cornell 到 Nvidia 的職業旅程" },
  ...
  FOOTER: {
    ...
    copyright: `© ${year} 扶搖計劃 All Rights Reserved.`,
    quickLinks: "快速連結",
    contactWay: "聯繫方式",
    language: "語言",
  },
